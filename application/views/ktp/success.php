            ...
            <div class="page-breadcrumb-wrap">
                ...
                <div class="page-breadcrumb-info">
                    ...
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page"> Insert Success</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="widget-container">
                                <div class=" widget-block">
                                    <div class="alert alert-success" role="alert">
                                        <strong>Sukses!</strong> Data berhasil dimasukan dengan NIK: <strong><?=$data['nik']?></strong>.
                                    </div>
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-md-12'>
                                            ...
                                            <div class='col-md-4'>
                                                 <a href="<?=base_url()?>data_ktp/insert" class='btn btn-flat btn-primary btn-sm pull-left'> Masukan Data Lagi</a>
                                            </div>
                                            <div class='col-md-4'>
                                                 <a href="<?=base_url()?>data_ktp" class='btn btn-flat btn-primary btn-sm pull-right'> Lihat Data KTP</a>
                                            </div>
