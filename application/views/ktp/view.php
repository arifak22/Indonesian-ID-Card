                            ...
                            <div class="widget-container">
                                <div class=" widget-block">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <a href="<?=base_url()?>data_ktp/export_csv" class="btn btn-flat btn-primary btn-sm"><!-- <i class="fa fa-file-excel-o"></i> --> Export Data To CSV</a>
                                    </div>
                    ...
                    <script type="text/javascript" language="javascript" >
                        $(document).ready(function() {
                            var dataTable = $('#data').DataTable( {
                                ...
                                "order": [], 
                                "ajax":{
                                    url :"<?php echo base_url();?>data_ktp/view_data", // json datasource
